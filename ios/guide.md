...
#### Sign Up with Facebook|users-signup-via-facebook
...
#### Sign In With Facebook|users-signin-via-facebook
#####동기식 코드
...
#### Unsubscribe User|users-unsubscribe
회원탈퇴기능을 구현할 수 있습니다.
#####동기식 코드
...
대부분의 경우 동기(Sync)와 비동기(Async) API를 동시에 제공하나, 일반적으로 대부분의 프로그래밍을 비동기(Async)로 작성됩니다.
...
#### Entity Relationship|data-connect 
...
#### Search Users In Group|query-users-from-group
...
#### Search Entity With Relationship|query-entities-with-relationship
...
#### Add User To Group|group-add-user
그룹에 회원을 추가합니다.
#####동기식 코드
    BaasioGroup *group = [[BaasioGroup alloc]init];
...
#### Delete User To Group|group-remove-user
그룹에 있는 회원을 삭제합니다.
...
#### Update File (Blob)|file-update-blob
...
#### Update File Entity|file-update-entity
...
#### Get File Entity|file-get-entity
File의 정보를 얻을 수 있습니다. 
...
#### Device Unregister|push-unregister 
로그 아웃 시에 호출해주면 됩니다.
...
#### 도움말(FAQ) 검색|helpcenter-search-faq
...
#### 도움말(FAQ) 상세내용 보기|helpcenter-get-faq-content
